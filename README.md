...
1. Download your preferred flavor and accent from the [latest GitHub release](https://github.com/catppuccin/cursors/releases/tag/v0.2.2).
...
curl -LOsS https://github.com/catppuccin/cursors/releases/download/v0.2.2/catppuccin-frappe-blue-cursors.zip
